...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderLight();
  });
  ...
  describe('HelloAssoApiV5ModelsStatisticsOrderLight', function() {
    it('should create an instance of HelloAssoApiV5ModelsStatisticsOrderLight', function() {
      // uncomment below and update the code to test HelloAssoApiV5ModelsStatisticsOrderLight
      //var instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderLight();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderLight);
    });
