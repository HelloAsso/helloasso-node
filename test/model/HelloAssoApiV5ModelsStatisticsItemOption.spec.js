...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsItemOption();
  });
  ...
  describe('HelloAssoApiV5ModelsStatisticsItemOption', function() {
    it('should create an instance of HelloAssoApiV5ModelsStatisticsItemOption', function() {
      // uncomment below and update the code to test HelloAssoApiV5ModelsStatisticsItemOption
      //var instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsItemOption();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5ModelsStatisticsItemOption);
    });
