...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5ModelsFormsFormBasicModel();
  });
  ...
  describe('HelloAssoApiV5ModelsFormsFormBasicModel', function() {
    it('should create an instance of HelloAssoApiV5ModelsFormsFormBasicModel', function() {
      // uncomment below and update the code to test HelloAssoApiV5ModelsFormsFormBasicModel
      //var instance = new HelloAssoApi.HelloAssoApiV5ModelsFormsFormBasicModel();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5ModelsFormsFormBasicModel);
    });
