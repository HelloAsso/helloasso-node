...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormPublicModel();
  });
  ...
  describe('HelloAssoApiV5CommonModelsFormsFormPublicModel', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsFormsFormPublicModel', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsFormsFormPublicModel
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormPublicModel();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormPublicModel);
    });

    it('should have the property organizationLogo (base name: "organizationLogo")', function() {
      // uncomment below and update the code to test the property organizationLogo
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormPublicModel();
