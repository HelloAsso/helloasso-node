...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderDetail();
  });
  ...
  describe('HelloAssoApiV5ModelsStatisticsOrderDetail', function() {
    it('should create an instance of HelloAssoApiV5ModelsStatisticsOrderDetail', function() {
      // uncomment below and update the code to test HelloAssoApiV5ModelsStatisticsOrderDetail
      //var instance = new HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderDetail();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5ModelsStatisticsOrderDetail);
    });
