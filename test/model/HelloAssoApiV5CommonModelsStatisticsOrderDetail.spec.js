...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrderDetail();
  });
  ...
  describe('HelloAssoApiV5CommonModelsStatisticsOrderDetail', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsStatisticsOrderDetail', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsStatisticsOrderDetail
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrderDetail();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrderDetail);
    });
