...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsItemOption();
  });
  ...
  describe('HelloAssoApiV5CommonModelsStatisticsItemOption', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsStatisticsItemOption', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsStatisticsItemOption
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsItemOption();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsItemOption);
    });
