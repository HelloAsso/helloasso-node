...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5ModelsFormsFormPublicModel();
  });
  ...
  describe('HelloAssoApiV5ModelsFormsFormPublicModel', function() {
    it('should create an instance of HelloAssoApiV5ModelsFormsFormPublicModel', function() {
      // uncomment below and update the code to test HelloAssoApiV5ModelsFormsFormPublicModel
      //var instance = new HelloAssoApi.HelloAssoApiV5ModelsFormsFormPublicModel();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5ModelsFormsFormPublicModel);
    });
