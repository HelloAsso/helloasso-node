...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrder();
  });
  ...
  describe('HelloAssoApiV5CommonModelsStatisticsOrder', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsStatisticsOrder', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsStatisticsOrder
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrder();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsStatisticsOrder);
    });
