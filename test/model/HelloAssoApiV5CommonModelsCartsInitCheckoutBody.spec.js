...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsCartsInitCheckoutBody();
  });
  ...
  describe('HelloAssoApiV5CommonModelsCartsInitCheckoutBody', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsCartsInitCheckoutBody', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsCartsInitCheckoutBody
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsCartsInitCheckoutBody();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsCartsInitCheckoutBody);
    });
