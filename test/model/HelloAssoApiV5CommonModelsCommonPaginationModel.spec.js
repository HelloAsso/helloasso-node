...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsCommonPaginationModel();
  });
  ...
  describe('HelloAssoApiV5CommonModelsCommonPaginationModel', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsCommonPaginationModel', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsCommonPaginationModel
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsCommonPaginationModel();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsCommonPaginationModel);
    });
