...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormLightModel();
  });
  ...
  describe('HelloAssoApiV5CommonModelsFormsFormLightModel', function() {
    it('should create an instance of HelloAssoApiV5CommonModelsFormsFormLightModel', function() {
      // uncomment below and update the code to test HelloAssoApiV5CommonModelsFormsFormLightModel
      //var instance = new HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormLightModel();
      //expect(instance).to.be.a(HelloAssoApi.HelloAssoApiV5CommonModelsFormsFormLightModel);
    });
