...
[**organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet**](FormsApi.md#organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet) | **GET** /organizations/{organizationSlug}/forms/{formType}/{formSlug}/stats | Get Stats for the form
...
## organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet

> HelloAssoApiV5CommonModelsFormsFormStatsModel organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet(organizationSlug, formSlug, formType)
...
let formSlug = "formSlug_example"; // String | 
let formType = new HelloAssoApi.HelloAssoApiV5CommonModelsEnumsFormType(); // HelloAssoApiV5CommonModelsEnumsFormType | 
apiInstance.organizationsOrganizationSlugFormsFormTypeFormSlugStatsGet(organizationSlug, formSlug, formType, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
