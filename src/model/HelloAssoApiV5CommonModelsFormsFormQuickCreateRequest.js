...
import HelloAssoApiV5CommonModelsCommonContactModel from './HelloAssoApiV5CommonModelsCommonContactModel';
...
import HelloAssoApiV5CommonModelsFormsTierLightModel from './HelloAssoApiV5CommonModelsFormsTierLightModel';

/**
 * The HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest model module.
 * @module model/HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest
 * @version public
 */
class HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest {
    /**
     * Constructs a new <code>HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest</code>.
     * @alias module:model/HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest
     * @param title {String} The title of the form. It will be used to generate the url which that can't be changed.
     */
    constructor(title) { 
        
        HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.initialize(this, title);
    }
    ...
    /**
     * Constructs a <code>HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest} obj Optional instance to populate.
     * @return {module:model/HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest} The populated <code>HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest();

            if (data.hasOwnProperty('tierList')) {
                obj['tierList'] = ApiClient.convertToType(data['tierList'], [HelloAssoApiV5CommonModelsFormsTierLightModel]);
            }
            ...
            if (data.hasOwnProperty('contact')) {
                obj['contact'] = HelloAssoApiV5CommonModelsCommonContactModel.constructFromObject(data['contact']);
            }
            ...
            if (data.hasOwnProperty('suggestMonthlyDonation')) {
                obj['suggestMonthlyDonation'] = ApiClient.convertToType(data['suggestMonthlyDonation'], 'Boolean');
            }
            if (data.hasOwnProperty('displayMonthlyDonationsFirst')) {
                obj['displayMonthlyDonationsFirst'] = ApiClient.convertToType(data['displayMonthlyDonationsFirst'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.RequiredProperties) {
        ...
        if (data['tierList']) { // data not null
            ...
            for (const item of data['tierList']) {
                HelloAssoApiV5CommonModelsFormsTierLightModel.validateJSON(item);
            };
        }
        ...
        if (data['contact']) { // data not null
          HelloAssoApiV5CommonModelsCommonContactModel.validateJSON(data['contact']);
        }
        // ensure the json data is a string
...
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.RequiredProperties = ["title"];

/**
 * @member {Array.<module:model/HelloAssoApiV5CommonModelsFormsTierLightModel>} tierList
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['tierList'] = undefined;

/**
 * The banner of the form
 * @member {String} banner
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['banner'] = undefined;

/**
 * The description of form
 * @member {String} description
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['description'] = undefined;

/**
 * The datetime of the activity end
 * @member {Date} endDate
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['endDate'] = undefined;

/**
 * The logo of the form
 * @member {String} logo
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['logo'] = undefined;

/**
 * Private Title : displayed only in the organization back office
 * @member {String} privateTitle
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['privateTitle'] = undefined;

/**
 * The datetime of the activity start
 * @member {Date} startDate
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['startDate'] = undefined;

/**
 * The title of the form. It will be used to generate the url which that can't be changed.
 * @member {String} title
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['title'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['activityTypeId'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5CommonModelsCommonPlaceModel} place
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['place'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['saleEndDate'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['saleStartDate'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5CommonModelsEnumsMembershipValidityType} validityType
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['validityType'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['acceptOpenDonation'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['acceptOpenMonthlyDonation'] = undefined;

/**
 * allowComment
 * @member {Boolean} allowComment
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['allowComment'] = undefined;

/**
 * amountVisible
 * @member {Boolean} amountVisible
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['amountVisible'] = undefined;

/**
 * The color of the form
 * @member {String} color
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['color'] = undefined;

/**
 * The text displayed in the widget button
 * @member {String} widgetButtonText
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['widgetButtonText'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5CommonModelsCommonContactModel} contact
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['contact'] = undefined;

/**
 * Display contributor name for fundraiser and donation forms.
 * @member {Boolean} displayContributorName
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['displayContributorName'] = undefined;

/**
 * Indicates that the members count must be displayed on the form.
 * @member {Boolean} displayParticipantsCount
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['displayParticipantsCount'] = undefined;

/**
 * Indicates that the remaining entries must be displayed on the form.
 * @member {Boolean} displayRemainingEntries
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['displayRemainingEntries'] = undefined;

/**
 * Indicates the financial goal (amount of money raised) for the whole form. Null means no goal.
 * @member {Number} financialGoal
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['financialGoal'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['generateMembershipCards'] = undefined;

/**
 * Entrust the issuance of tickets to HelloAsso (automatically sent by email to participants)
 * @member {Boolean} generateTickets
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['generateTickets'] = undefined;

/**
 * Allows you to add the long description above the store catalog.
 * @member {Boolean} invertDescriptions
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['invertDescriptions'] = undefined;

/**
 * Label conditions and terms file
 * @member {String} labelConditionsAndTermsFile
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['labelConditionsAndTermsFile'] = undefined;

/**
 * The long description of the form (rich Html)
 * @member {String} longDescription
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['longDescription'] = undefined;

/**
 * The preset amounts to be shown to the user. Maximum 3 amounts.
 * @member {Array.<Number>} openDonationPresetAmounts
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['openDonationPresetAmounts'] = undefined;

/**
 * Personalized message for participants
 * @member {String} personalizedMessage
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['personalizedMessage'] = undefined;

/**
 * The project beneficiaries of the form (rich Html)
 * @member {String} projectBeneficiaries
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['projectBeneficiaries'] = undefined;

/**
 * Details of the project expenses (rich Html)
 * @member {String} projectExpensesDetails
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['projectExpensesDetails'] = undefined;

/**
 * Description of the project owners (rich Html)
 * @member {String} projectOwners
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['projectOwners'] = undefined;

/**
 * Suggest monthly donation for donation forms.
 * @member {Boolean} suggestMonthlyDonation
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['suggestMonthlyDonation'] = undefined;

/**
 * The monthly donation option should be displayed or selected by default for donation forms.
 * @member {Boolean} displayMonthlyDonationsFirst
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['displayMonthlyDonationsFirst'] = undefined;

/**
 * 3 letter country code
 * @member {String} projectTargetCountry
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['projectTargetCountry'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['allowOrganismPayer'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest.prototype['maxEntries'] = undefined;
...
export default HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest;
