 ...
 * @module model/ResultsWithPaginationModelPartnerOrganizationModel
 * @version public
 */
class ResultsWithPaginationModelPartnerOrganizationModel {
    /**
     * Constructs a new <code>ResultsWithPaginationModelPartnerOrganizationModel</code>.
     * ResultsWithPaginationModel class
     * @alias module:model/ResultsWithPaginationModelPartnerOrganizationModel
     */
    constructor() { 
        
        ResultsWithPaginationModelPartnerOrganizationModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResultsWithPaginationModelPartnerOrganizationModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResultsWithPaginationModelPartnerOrganizationModel} obj Optional instance to populate.
     * @return {module:model/ResultsWithPaginationModelPartnerOrganizationModel} The populated <code>ResultsWithPaginationModelPartnerOrganizationModel</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ResultsWithPaginationModelPartnerOrganizationModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResultsWithPaginationModelPartnerOrganizationModel</code>.
     */
...
export default ResultsWithPaginationModelPartnerOrganizationModel;
