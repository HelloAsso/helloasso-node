...
/**
 * The HelloAssoApiV5ModelsStatisticsItemDetail model module.
 * @module model/HelloAssoApiV5ModelsStatisticsItemDetail
 * @version public
 */
class HelloAssoApiV5ModelsStatisticsItemDetail {
    /**
     * Constructs a new <code>HelloAssoApiV5ModelsStatisticsItemDetail</code>.
     * @alias module:model/HelloAssoApiV5ModelsStatisticsItemDetail
     */
    constructor() { 
        
        HelloAssoApiV5ModelsStatisticsItemDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HelloAssoApiV5ModelsStatisticsItemDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HelloAssoApiV5ModelsStatisticsItemDetail} obj Optional instance to populate.
     * @return {module:model/HelloAssoApiV5ModelsStatisticsItemDetail} The populated <code>HelloAssoApiV5ModelsStatisticsItemDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HelloAssoApiV5ModelsStatisticsItemDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>HelloAssoApiV5ModelsStatisticsItemDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelloAssoApiV5ModelsStatisticsItemDetail</code>.
     */
 ...
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['order'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsStatisticsPayer} payer
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['payer'] = undefined;

/**
 * Payments linked to this item
 * @member {Array.<module:model/HelloAssoApiV5ModelsStatisticsItemPayment>} payments
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['payments'] = undefined;

/**
 * @member {String} name
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['name'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsStatisticsUser} user
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['user'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsEnumsPriceCategory} priceCategory
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['priceCategory'] = undefined;

/**
 * Minimum amount that was specified on the tier (in cents)
 * @member {Number} minAmount
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['minAmount'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsStatisticsItemDiscount} discount
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['discount'] = undefined;

/**
 * Custom fields related to this item
 * @member {Array.<module:model/HelloAssoApiV5ModelsStatisticsItemCustomField>} customFields
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['customFields'] = undefined;

/**
 * Extra options taken with this item
 * @member {Array.<module:model/HelloAssoApiV5ModelsStatisticsItemOption>} options
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['options'] = undefined;

/**
 * The Ticket Url
 * @member {String} ticketUrl
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['ticketUrl'] = undefined;

/**
 * The item QrCode (for ticket scanning only)
 * @member {String} qrCode
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['qrCode'] = undefined;

/**
 * The Membership Card Url
 * @member {String} membershipCardUrl
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['membershipCardUrl'] = undefined;

/**
 * The day of levy for monthly donation only
 * @member {Number} dayOfLevy
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['dayOfLevy'] = undefined;

/**
 * Tier description
 * @member {String} tierDescription
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['tierDescription'] = undefined;

/**
 * @member {Number} tierId
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['tierId'] = undefined;

/**
 * @member {String} comment
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['comment'] = undefined;

/**
 * ID of the Item
 * @member {Number} id
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['id'] = undefined;

/**
 * Total item Price in cents (after discount without extra options)
 * @member {Number} amount
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['amount'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsEnumsTierType} type
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['type'] = undefined;

/**
 * The raw amount (without reduction)
 * @member {Number} initialAmount
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['initialAmount'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5ModelsEnumsItemState} state
 */
HelloAssoApiV5ModelsStatisticsItemDetail.prototype['state'] = undefined;
...
export default HelloAssoApiV5ModelsStatisticsItemDetail;
