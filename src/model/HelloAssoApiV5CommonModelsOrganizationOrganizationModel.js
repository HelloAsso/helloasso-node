...
/**
 * The HelloAssoApiV5CommonModelsOrganizationOrganizationModel model module.
 * @module model/HelloAssoApiV5CommonModelsOrganizationOrganizationModel
 * @version public
 */
class HelloAssoApiV5CommonModelsOrganizationOrganizationModel {
    /**
     * Constructs a new <code>HelloAssoApiV5CommonModelsOrganizationOrganizationModel</code>.
     * OrganizationsModel class
     * @alias module:model/HelloAssoApiV5CommonModelsOrganizationOrganizationModel
     */
    constructor() { 
        
        HelloAssoApiV5CommonModelsOrganizationOrganizationModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HelloAssoApiV5CommonModelsOrganizationOrganizationModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HelloAssoApiV5CommonModelsOrganizationOrganizationModel} obj Optional instance to populate.
     * @return {module:model/HelloAssoApiV5CommonModelsOrganizationOrganizationModel} The populated <code>HelloAssoApiV5CommonModelsOrganizationOrganizationModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HelloAssoApiV5CommonModelsOrganizationOrganizationModel();
    ...
    /**
     * Validates the JSON data with respect to <code>HelloAssoApiV5CommonModelsOrganizationOrganizationModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HelloAssoApiV5CommonModelsOrganizationOrganizationModel</code>.
     */
 ...
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['isAuthenticated'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['isCashInCompliant'] = undefined;

/**
 * The organization banner
 * @member {String} banner
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['banner'] = undefined;
 ...
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['fiscalReceiptEligibility'] = undefined;

/**
 * The organism is eligible, has set up his options, and is authenticated.
 * @member {Boolean} fiscalReceiptIssuanceEnabled
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['fiscalReceiptIssuanceEnabled'] = undefined;

/**
 * @member {module:model/HelloAssoApiV5CommonModelsEnumsOrganizationType} type
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['type'] = undefined;

/**
 * Organization category label
 * @member {String} category
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['category'] = undefined;

/**
 * Organization Address (for authorized applications or if authorized by the organization)
 * @member {String} address
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['address'] = undefined;

/**
 * @member {module:model/HelloAssoModelsSharedGeoLocation} geolocation
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['geolocation'] = undefined;

/**
 * Unique identifier assigned when creating the association
 * @member {String} rnaNumber
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['rnaNumber'] = undefined;

/**
 * Logo of organization
 * @member {String} logo
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['logo'] = undefined;

/**
 * Name of organization
 * @member {String} name
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['name'] = undefined;

/**
 * @member {module:model/HelloAssoModelsEnumsGlobalRole} role
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['role'] = undefined;

/**
 * Organization city
 * @member {String} city
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['city'] = undefined;

/**
 * Organization zip code
 * @member {String} zipCode
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['zipCode'] = undefined;

/**
 * Organization description
 * @member {String} description
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['description'] = undefined;

/**
 * Last update date of the organization
 * @member {Date} updateDate
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['updateDate'] = undefined;

/**
 * @member {Number} categoryJoId
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['categoryJoId'] = undefined;

/**
 * The organization url
 * @member {String} url
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['url'] = undefined;

/**
 * The organization slug
 * @member {String} organizationSlug
 */
HelloAssoApiV5CommonModelsOrganizationOrganizationModel.prototype['organizationSlug'] = undefined;
...
export default HelloAssoApiV5CommonModelsOrganizationOrganizationModel;
