 ...
 * @module model/ResultsWithPaginationModelItem
 * @version public
 */
class ResultsWithPaginationModelItem {
    /**
     * Constructs a new <code>ResultsWithPaginationModelItem</code>.
     * ResultsWithPaginationModel class
     * @alias module:model/ResultsWithPaginationModelItem
     */
    constructor() { 
        
        ResultsWithPaginationModelItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResultsWithPaginationModelItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResultsWithPaginationModelItem} obj Optional instance to populate.
     * @return {module:model/ResultsWithPaginationModelItem} The populated <code>ResultsWithPaginationModelItem</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ResultsWithPaginationModelItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResultsWithPaginationModelItem</code>.
     */
...
export default ResultsWithPaginationModelItem;
