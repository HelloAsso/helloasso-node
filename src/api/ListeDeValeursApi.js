...
export default class ListeDeValeursApi {
    ...
    */
     ...
     * @param {Array.<module:model/HelloAssoApiV5ModelsAccountCompanyLegalStatusModel>} data The data returned by the service call.
     ...
     * data is of type: {@link Array.<module:model/HelloAssoApiV5ModelsAccountCompanyLegalStatusModel>}
     */
    valuesCompanyLegalStatusGet(callback) {
      ...
      let returnType = [HelloAssoApiV5ModelsAccountCompanyLegalStatusModel];
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/HelloAssoApiV5ModelsAccountOrganismCategoryModel>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/HelloAssoApiV5ModelsAccountOrganismCategoryModel>}
     */
    valuesOrganizationCategoriesGet(callback) {
      ...
      let contentTypes = [];
      let accepts = ['text/plain', 'application/json', 'text/json'];
      let returnType = [HelloAssoApiV5ModelsAccountOrganismCategoryModel];
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/HelloAssoApiV5ModelsTagsPublicTagModel>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/HelloAssoApiV5ModelsTagsPublicTagModel>}
     */
    valuesTagsGet(callback) {
      ...
      let contentTypes = [];
      let accepts = ['text/plain', 'application/json', 'text/json'];
      let returnType = [HelloAssoApiV5ModelsTagsPublicTagModel];
      return this.apiClient.callApi(
        '/values/tags', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
